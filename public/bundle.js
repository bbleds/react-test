...
/***/ function(module, exports, __webpack_require__) {
	...
	React.createElement(
	  'div',
	  null,
	  React.createElement(Greeter, { name: examplePassingInProps, message: exampleMessage })
	),
	// pass dom node
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'text', ref: 'name', placeholder: 'Please enter your name in this greeter message' }),
